...
$prod = new Producto();
$motherBoards = $prod->getProducts('MOTHER');
        ...
        <div class="row">
          ...
          <div id="store" class="col-md-12">
            ...
            <div class="row">
              ...
              <?php foreach($motherBoards as $mother){
              $srcMother = "./img/PRODUCTS/ALL_SMALL/" .$mother['id']. ".webp"; ?>
              <!-- product -->
              <div class="col-md-3 col-xs-6">
                <div class="product">
                  <div class="product-img">
                    <img src="<?php echo $srcMother ;?>" alt="" />
                  </div>
                  <div class="product-body">
                    <p class="product-category">Placas Base</p>
                    <h3 class="product-name">
                      <a href="#"><?php echo $mother['nombre_corto'] ;?></a>
                    </h3>
                    <h4 class="product-price">
                      <?php echo $mother['pvp'] ."€" ;?>
                    </h4>
